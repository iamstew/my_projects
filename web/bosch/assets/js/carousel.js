...
review_text.forEach(function (Element) {
    if (Element.scrollHeight > Element.offsetHeight) {
        ...
        div_button.className = "button_reviews button-theme";
...
function Ant(crslId) {
    ...
    this.crslElements = this.crslList.querySelectorAll(
        ".ant-carousel-element"
    );
    this.crslElemFirst = this.crslList.querySelector(
        ".ant-carousel-element"
    );
    ...
    this.indicatorDots = this.crslRoot.querySelector(
...
Ant.initialize = function (that) {
    ...
    if (that.crslElements.length === 0) {
        document.querySelector(".section_carousel").style.display = "none";
        return;
    }
...
new Ant('antCarouselHome');

let questionActive = document.querySelectorAll('.section_questions_item');
questionActive.forEach(element => {
    element.onclick = () => {
        element.getElementsByClassName("answer_item")[0]
            .classList.toggle("answer_item_active");
        element.getElementsByClassName("questions_item_active")[0]
            .classList.toggle("questions_item_active_on");
    }
});